<template>
  <section class="calculator container">
    <div class="container">
      ...
      <div class="calculator__row calculator__filter">
        <div>
          <Filter />
        </div>
      ...
      <div class="calculator__row calculator__prices">
        ...
        <div>
          <span>{{ priceValue ? priceValue : 0 }}</span> руб./мес.
        </div>
      </div>
      <Slider
        @actualValue="priceValue = $event"
        min="0"
        max="28000"
        value="0"
        step="0"
    ...
    <div class="container">
      <TagH className="calculator__title" type="h3"
        >План продвижения на 3 месяца</TagH
      >
      <PromoteList />
    </div>
  </section>
...
export default {
  components: { TagH, Checkbox, Slider, Button, PromoteList, Filter },
};
</script>
